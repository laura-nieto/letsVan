...
<section class="background-lets text-white mt-5 p-5 descripcion d-flex justify-content-center">
...
<section class="p-4 w-95 mt-5 mx-auto d-flex flex-md-row flex-column caracteristicas">
    <div class="d-flex flex-column">
        ...
        <div class="d-flex justify-content-center my-md-auto my-5">
...
<section class="mt-5 p-5 background-lets text-white">
