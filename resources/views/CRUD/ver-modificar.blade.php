                            ...
                            @foreach ($unidades as $unity)
                                <tr>
                                    ...
                                    <td class="d-flex d-flex-justify-around around--btn">
                                        <a href="{{Request::segment(1) . '/' . $unity->id . '/edit'}}" class="btn btn-lets">Modificar</a>
                            ...
                            <tbody>
                                @foreach ($choferes as $chofer)
                                    <tr>
                                        ...
                                        <td class="d-flex d-flex-justify-around around--btn">
                                            <a href="{{Request::segment(1) . '/' . $chofer->id . '/edit'}}" class="btn btn-lets">Modificar</a>
                                ...
                                <tbody>
                                    @foreach ($corridas as $corrida)
                                        <tr>
                                            ...
                                            <td class="d-flex d-flex-justify-around around--btn">
                                                <a href="{{Request::segment(1) . '/' . $corrida->id . '/edit'}}" class="btn btn-lets">Modificar</a>
                            ...
                            <tbody>
                                @foreach ($servicios as $servicio)
                                    <tr>
                                        ...
                                        <td class="d-flex d-flex-justify-around around--btn">
                                            <a href="{{Request::segment(1) . '/' . $servicio->id . '/edit'}}" class="btn btn-lets">Modificar</a>
