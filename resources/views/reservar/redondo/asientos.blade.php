...
@section('main')
    <article class="home--title">
        ...
        <h2 class="text-center mt-4">{{ $title==0 ? 'VIAJE IDA':'VIAJE VUELTA' }}</h2>
    </article>
    @if (session('error'))
    ...
    <article class="w-75 m-auto reservar--asientos">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" class="size-input-check propio-check" name="asiento[]" value="12" {{$ida->asientos->where('asiento',12)->isNotEmpty() ? 'disabled':''}} id="12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" class="size-input-check propio-check" name="asiento[]" value="13" {{$ida->asientos->where('asiento',13)->isNotEmpty() ? 'disabled':''}} id="13">
                                    <label for="13" class="label-propio-check"><img src="{{asset('/img/armchair.png')}}" alt=""></label>
                                </td>   
                            </tr>
                        </tbody>
                    </table>
                    <button type="submit" class="btn btn-primary my-4 mx-auto">Seleccionar</button>
        ...
        <section class="d-flex justify-content-center asientos-reserva-13">
            <form action="" method="post" class="d-flex flex-column">
                @csrf
                <input type="hidden" id="limit" value="{{$cantidad_ida}}">
                <table class="table table-padding-0">
                    <tbody>
                        <tr>
                            <td>
                                <input type="checkbox" class="size-input-check propio-check"  name="asiento[]" value="1" {{$ida->asientos->where('asiento',1)->isNotEmpty() ? 'disabled':''}} id="1">
                            ...
                            <td>
                                <input type="checkbox" class="size-input-check propio-check"  name="asiento[]" value="14" {{$ida->asientos->where('asiento',14)->isNotEmpty() ? 'disabled':''}} id="14">
                                <label for="14" class="label-propio-check"><img src="{{asset('/img/armchair.png')}}" alt=""></label>
                            </td>
                            <td>
                                <input type="checkbox" class="size-input-check propio-check"  name="asiento[]" value="17" {{$ida->asientos->where('asiento',17)->isNotEmpty() ? 'disabled':''}} id="17">
                        ...
                        <tr>  
                            ...
                            <td></td>
                            <td>
                                <input type="checkbox" class="size-input-check propio-check"  name="asiento[]" value="18" {{$ida->asientos->where('asiento',18)->isNotEmpty() ? 'disabled':''}} id="18">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" class="size-input-check propio-check"  name="asiento[]" value="15" {{$ida->asientos->where('asiento',15)->isNotEmpty() ? 'disabled':''}} id="15">
                                <label for="15" class="label-propio-check"><img src="{{asset('/img/armchair.png')}}" alt=""></label>
                            </td>
                            <td>
                                <input type="checkbox" class="size-input-check propio-check"  name="asiento[]" value="19" {{$ida->asientos->where('asiento',19)->isNotEmpty() ? 'disabled':''}} id="19">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" class="size-input-check propio-check"  name="asiento[]" value="16" {{$ida->asientos->where('asiento',16)->isNotEmpty() ? 'disabled':''}} id="16">
                                <label for="16" class="label-propio-check"><img src="{{asset('/img/armchair.png')}}" alt=""></label>
                            </td>
                            <td>
                                <input type="checkbox" class="size-input-check propio-check"  name="asiento[]" value="20" {{$ida->asientos->where('asiento',20)->isNotEmpty() ? 'disabled':''}} id="20">
